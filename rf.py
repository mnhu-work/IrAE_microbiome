...
## plot ROC
lines, mean_fpr, mean_tpr, tprs, std_auc = plot_data
...
plt.plot([0, 1], [0, 1], ls='--', lw=2, color='#ffa801')
plt.plot(mean_fpr, mean_tpr, color='#227093', lw=2.5,label='Mean ROC(AUC=%0.3f $\pm$ %0.3f)'%(roc_auc, std_auc))
...
plt.show()
#fig.savefig('rf_ROC.pdf',dpi=300,format='pdf')
